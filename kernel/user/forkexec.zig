...
//!
//! The x86_64 twin of user/forkexec_aarch64.zig. Nothing here has ever been
//! tried on this architecture: /bin/clarity-forkprobe forks and both halves
//! exit without exec'ing, so whether a forked child can become another
//! program is an open question and this is what asks it.
//!
...
/// Something only this program does, in a callee-saved register,
...
fn read_mark() u64 {
    return asm volatile ("movq %%r15, %[out]"
        : [out] "=r" (-> u64),
    );
}
